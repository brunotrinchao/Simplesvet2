...
$htmlForm .= $form->addSelect('pro_int_cod', array(), '', 'Proprietário*', array('validate' => 'required'), false, false, true, '', 'Selecione...');
$htmlForm .= $form->addSelect('rac_int_cod', array(), '', 'Raça*', array('validate' => 'required'), false, false, true, '', 'Selecione...');
