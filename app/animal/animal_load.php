...
try {
    if ($type == 'C') {
        ...
        $query = "SELECT ani_int_codigo, pro_int_codigo, rac_int_codigo, ani_var_nome, ani_var_vivo, ani_dec_peso, pro_var_nome, rac_var_nome FROM vw_animal " . $filter->getWhere();
        $param = $filter->getParam();
